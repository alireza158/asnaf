    ...
    public function run(): void
    {
        ...
        DB::transaction(function () use ($data, $now): void {
            ...
            foreach ($guildIds as $slug => $guildId) {
                ...
                $blocks = [
                    ['head', 'رییس '.$guildTitle, 'معرفی رئیس و توضیح کوتاه اتحادیه', []],
                    ['board', 'هیئت مدیره و اعضای نمونه', 'اعضای قابل نمایش و قابل پیامک اتحادیه', []],
                    ...
                    ['commissions', 'کمیسیون‌های اتحادیه', 'کارگروه‌ها و کمیسیون‌های مرتبط با این اتحادیه', []],
                    ...
                    ['news_slider', 'اسلایدر خبری اتحادیه', 'خبرهای شاخص این اتحادیه', []],
                    ['latest_news', 'آخرین اخبار '.$guildTitle, 'آخرین خبرها و گزارش‌های مرتبط با اتحادیه', []],
                    ...
                    ['complaint', 'ثبت شکایت صنفی', 'نمایش یا عدم نمایش شکایت برای این اتحادیه', []],
                    ...
                    ['announcements', 'اطلاعیه و بخشنامه‌ها', 'اطلاعیه‌های رسمی اتحادیه', []],
                    ...
                    ['search', 'جستجو در '.$guildTitle, 'جستجو در اخبار، اعضا، قوانین و اطلاعات اتحادیه', []],
